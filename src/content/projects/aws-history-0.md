---
title: "AWS History 0 - An attack and Three tier solution"
meta_title: "AWS History 0 - An attack and Three tier solution"
description: "The beginning of some histories about AWS cloud. This one is about EC2, S3 configuration and a little bit of Linux server management"
date: 2024-08-30
draft: false
category: "client"

image: "/images/projects/aws-history-0/aws-synthwave.jpg"
thumbnail: "/images/projects/aws-history-0/aws-synthwave.jpg"
...
client_info:
  ...
  - icon: "/images/icons/paidtimeoff.svg"
    label: "Service"
    value: "AWS Administration"
  - icon: "/images/icons/wellbeing.svg"
    label: "Engagement"
    value: "AWS Services configuration"

overview:
  image: "/images/projects/aws-history-0/process.svg"
  title: "Overview"
  content: |
...
![Disk storage available](/images/projects/aws-history-0/disk-storage-available.png)
And Monday morning was like this:
![Disk storage full](/images/projects/aws-history-0/disk-storage-full.png)
...
![Crontab](/images/projects/aws-history-0/cron-jobs.png)
...
To resolve the S3 backup issue, I created a new S3 bucket in the shop's own account and updated the sync command to point to this bucket. Additionally, we modified the scheduled task timing to send data weekly on Sundays and monthly on the first day of each month.

![Change cron job](/images/projects/aws-history-0/change-cron-job.png)
...
![Change instance type](/images/projects/aws-history-0/instance-type.png)
# Conclusions
